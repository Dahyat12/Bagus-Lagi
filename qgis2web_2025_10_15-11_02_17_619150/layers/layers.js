...
var format_SHP_Kecamatan_Aceh_2 = new ol.format.GeoJSON();
var features_SHP_Kecamatan_Aceh_2 = format_SHP_Kecamatan_Aceh_2.readFeatures(json_SHP_Kecamatan_Aceh_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SHP_Kecamatan_Aceh_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SHP_Kecamatan_Aceh_2.addFeatures(features_SHP_Kecamatan_Aceh_2);
var lyr_SHP_Kecamatan_Aceh_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SHP_Kecamatan_Aceh_2, 
                style: style_SHP_Kecamatan_Aceh_2,
                popuplayertitle: 'SHP_Kecamatan_Aceh',
                interactive: false,
                title: '<img src="styles/legend/SHP_Kecamatan_Aceh_2.png" /> SHP_Kecamatan_Aceh'
            });
var format_WPPINDONESIA_3 = new ol.format.GeoJSON();
var features_WPPINDONESIA_3 = format_WPPINDONESIA_3.readFeatures(json_WPPINDONESIA_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_WPPINDONESIA_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_WPPINDONESIA_3.addFeatures(features_WPPINDONESIA_3);
var lyr_WPPINDONESIA_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_WPPINDONESIA_3, 
                style: style_WPPINDONESIA_3,
                popuplayertitle: 'WPP INDONESIA',
                interactive: false,
    title: 'WPP INDONESIA<br />\
    <img src="styles/legend/WPPINDONESIA_3_0.png" /> Aceh<br />\
    <img src="styles/legend/WPPINDONESIA_3_1.png" /> WPP 571<br />\
    <img src="styles/legend/WPPINDONESIA_3_2.png" /> WPP 572<br />' });
...
lyr_GoogleSatellite_0.setVisible(true);lyr_OSMStandard_1.setVisible(true);lyr_SHP_Kecamatan_Aceh_2.setVisible(true);lyr_WPPINDONESIA_3.setVisible(true);lyr_WilayahPelabuhan_4.setVisible(true);lyr_PelabuhanAceh_5.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_OSMStandard_1,lyr_SHP_Kecamatan_Aceh_2,lyr_WPPINDONESIA_3,lyr_WilayahPelabuhan_4,lyr_PelabuhanAceh_5];
lyr_SHP_Kecamatan_Aceh_2.set('fieldAliases', {'Kab_Code': 'Kab_Code', 'Kec_Code': 'Kec_Code', 'Kabupaten': 'Kabupaten', 'Kecamatan': 'Kecamatan', 'Kec_CodeBr': 'Kec_CodeBr', 'Keterangan': 'Keterangan', });
lyr_WPPINDONESIA_3.set('fieldAliases', {'fid': 'fid', 'Keterang_1': 'Keterang_1', });
...
lyr_SHP_Kecamatan_Aceh_2.set('fieldImages', {'Kab_Code': 'TextEdit', 'Kec_Code': 'TextEdit', 'Kabupaten': 'TextEdit', 'Kecamatan': 'TextEdit', 'Kec_CodeBr': 'TextEdit', 'Keterangan': 'TextEdit', });
lyr_WPPINDONESIA_3.set('fieldImages', {'fid': 'TextEdit', 'Keterang_1': 'TextEdit', });
...
lyr_SHP_Kecamatan_Aceh_2.set('fieldLabels', {'Kab_Code': 'header label - always visible', 'Kec_Code': 'header label - always visible', 'Kabupaten': 'header label - always visible', 'Kecamatan': 'header label - always visible', 'Kec_CodeBr': 'header label - always visible', 'Keterangan': 'header label - always visible', });
lyr_WPPINDONESIA_3.set('fieldLabels', {'fid': 'no label', 'Keterang_1': 'no label', });
