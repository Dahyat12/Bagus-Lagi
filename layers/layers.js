...
lyr_WPPIndonesia_2.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'PROVINSI': 'PROVINSI', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', 'id': 'id', 'Keterangan': 'Keterangan', 'x label': 'x label', 'y label': 'y label', });
...
lyr_WPPIndonesia_2.set('fieldImages', {'OBJECTID': 'TextEdit', 'PROVINSI': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', 'id': 'TextEdit', 'Keterangan': 'TextEdit', 'x label': 'TextEdit', 'y label': 'TextEdit', });
...
lyr_WPPIndonesia_2.set('fieldLabels', {'OBJECTID': 'no label', 'PROVINSI': 'no label', 'Shape_Leng': 'no label', 'Shape_Area': 'no label', 'id': 'no label', 'Keterangan': 'no label', 'x label': 'no label', 'y label': 'no label', });
